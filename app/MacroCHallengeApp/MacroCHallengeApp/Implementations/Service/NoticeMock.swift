...
func getNoticeEtec() -> Notice {
	let topics = [
		"Matemática":[
			"Expressões numéricas e problemas envolvendo números reais e as operações de adição, subtração, multiplicação, divisão, potenciação e radiciação.",
			"Problemas básicos de lógica.",
			"Equações do 1º e do 2º grau.",
			"Cálculo algébrico, produtos notáveis e fatoração.",
			"Razão e proporção.",
			"Medidas de comprimento, de superfície, de volume, tempo e massa.",
			"Polígonos e suas propriedades, círculo e circunferência, ângulos, cálculo de áreas e perímetros de figuras planas e suas partes.",
			"Ângulos formados por retas paralelas cortadas por transversais.",
			"Teorema de Pitágoras.",
			"Semelhança de triângulos.",
			"Razões trigonométricas nos triângulos retângulos.",
			"Leitura e interpretação de tabelas e gráficos variados.",
			"Média aritmética simples e ponderada.",
			"Porcentagens.",
		],
		"Português":[
			"Compreensão e interpretação de textos.",
			"Relações gramaticais e semânticas.",
			"Sentido e significado de palavras e expressões contextualizadas.",
			"Relações de causa e consequência.",
			"Verossimilhança.",
			"REFLEXÃO SOBRE A LÍNGUA",
			"Classes gramaticais, termos da oração e orações do período.",
			"Concordância verbal e concordância nominal.",
			"Acordo ortográfico.",
			"LINGUÍSTICA",
			"Efeitos linguísticos (figuras de linguagem, figura de palavras e figura de pensamento).",
			"Vocabulário.",
			"Conotação e denotação.",
			"Coerência e coesão.",
			"LITERATURA (Trovadorismo, Humanismo, Classicismo, Barroco e Arcadismo)",
			"Identificação das escolas literárias.",
			"Características das escolas literárias.",
			"Características dos autores e das obras em contexto",
		],
		"Ciências Naturais":[
			"Meio ambiente",
			"Qualidade de vida",
			"Poluição do ar e do solo: fontes e efeitos sobre a saúde; Origem e evolução dos seres vivos; Características básicas dos seres vivos",
			...
			"A manutenção da integridade do organismo; Tipos de reprodução",
			...
			"Elementos químicos",
			"Tabela periódica",
			"Básico de reações químicas",
			"Estados da matéria",
			"Estrutura atômica",
			"Materiais no cotidiano e no sistema produtivo",
		...
		"Ciências Humanas":[
			...
			"Sociedades indígenas no Brasil. O tempo da natureza",
			"A leitura de paisagensAs paisagens da Terra; A linguagem dos mapas; A história da Terra e os recursos minerais",

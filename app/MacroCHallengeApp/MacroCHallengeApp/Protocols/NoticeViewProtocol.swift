...
protocol NoticeViewProtocol {
    /**
     ...
     - parameter data: Um  dicionário contendo as informações de um edital de uma escola que serão exibidas na view.
     - parameter controller: Um controlador do tipo NoticeViewControllerProtocol
     
     */
    init(data: [String:String], controller: NoticeViewControllerProtocol)
